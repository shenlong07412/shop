...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.plugin.sinaOAuth.setting")}
	</div>
	<form id="inputForm" action="update.jhtml" method="post">
		<table class="input">
			<tr>
				<th>
					<span class="requiredField">*</span>${message("OAuthSinaPlugin.OAuthName")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("OAuthSinaPlugin.AppID")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("OAuthSinaPlugin.AppKey")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("OAuthSinaPlugin.RedirectUri")}:
				</th>
				<td>
			...
			<tr>
				<th>
					${message("OAuthSinaPlugin.description")}:
				</th>
				<td>
			...
			<tr>
				<th>
					${message("OAuthSinaPlugin.isEnabled")}:
				</th>
				<td>
					<label>
