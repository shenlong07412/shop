...
<body>
	...
	<table class="input">
		...
		<tr>
			...
			<td>
				<a href="http://www.xmsoft.cn" target="_blank">http://www.xmsoft.cn</a>
			</td>
			<th>
				${message("admin.index.bbs")}:
			</th>
			<td>
				<a href="http://bbs.xmsoft.cn" target="_blank">http://bbs.xmsoft.cn</a>
			</td>
		</tr>
		<tr>
			<td colspan="4">
		...
		<tr>
			<td class="powered" colspan="4">
				COPYRIGHT © 2005-2013 XMSOFT.CN ALL RIGHTS RESERVED.
			</td>
		</tr>
	</table>
</body>
