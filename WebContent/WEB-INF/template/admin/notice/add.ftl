	...
	<form id="inputForm" action="save.jhtml" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="user" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="releaseTime" class="text" maxlength="200"  onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss' });"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="communityName" class="text" maxlength="200" id="areaName2"  readonly/>
					<input type="hidden" name="community.id" class="text" maxlength="200" id="areaId2"/>
			...
			<tr>
				...
				<td>
					<input type="text" name="communityNames" class="text" maxlength="200" id="areaName"  readonly/>
					<input type="hidden" name="communitys" class="text" maxlength="200" id="areaId"/>
			...
			<tr>
				...
				<td>
					  <input type="checkbox" id="isFixedTime" name="isFixedTime" value="1"  /> 
			...
			<tr>
				...
				<td>
					  <input type="text" name="sendTime" class="text" maxlength="200" class="text Wdate" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss' });"  />
			...
			<tr>
				...
				<td>
					<span class="fieldSet">
						<input type="text" name="attachmentUrl" class="text" maxlength="200" />
