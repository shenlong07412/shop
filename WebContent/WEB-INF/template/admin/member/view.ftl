	...
	<table class="input tabContent">
		<tr>
			...
			<td>
				...
				<img src="${base}/resources/shop/images/email1.jpg" width="30" high="30" alt="邮箱认证" title="邮箱认证已通过"/>
				[#else]
				<img src="${base}/resources/shop/images/email0.jpg" width="30" high="30" alt="邮箱认证" title="邮箱认证未通过" />
				[/#if]
				${(member.email)!}
			</td>
		</tr>
		<tr>
			...
			<td>
				[#if member.activateEmail]
				<img src="${base}/resources/shop/images/mobile1.jpg" width="30" high="30" alt="手机认证" title="手机认证已通过"/>
				[#else]
				<img src="${base}/resources/shop/images/mobile0.jpg" width="30" high="30" alt="手机认证" title="手机认证未通过"/>
				[/#if]
				${(member.mobile)!}
			</td>
		</tr>
		<tr>
			...
			<td>
				[#if member.activateEmail]
				<img src="${base}/resources/shop/images/realname1.jpg" width="30" high="30" alt="实名认证" title="实名认证已通过"/>
				[#else]
				<img src="${base}/resources/shop/images/realname0.jpg" width="30" high="30" alt="实名认证" title="实名认证未通过"/>
				[/#if]
				<br/>
				真实姓名：${(memberCertification.realname)!}
				<br/>
				身份证号码：${(memberCertification.idCard)!}
				<br/>
				身份证照片：
				<br/>
