...
<body>
	<div class="path">
		...
		<a href="${base}/admin/logConfig/list.jhtml">日志功能管理列表</a> &raquo; 添加
	</div>
	...
	<table class="input tabContent">
		<tr>
			...
			<td>
				<input type="text" name="operation" class="text" maxlength="100"/>			
			</td>
		</tr>
		<tr>
			<th>
			...
			<td>
				<input type="text" name="urlPattern" class="text" maxlength="100"/>	
			</td>
		</tr>	
	</table>	
	<table class="input">
