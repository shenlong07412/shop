...
<body>
	<div class="path">
		...
		<a href="${base}/admin/owner/list.jhtml">业主列表</a> &raquo; 添加
	</div>
	...
	<table class="input tabContent">
		...
		<tr>
			...
			<td>
				<input type="text" name="no" class="text" maxlength="100"/>			
			</td>
		</tr>
		<tr>
			<th>
		...
		<tr>
			...
			<td>
				<input type="text" name="sex" class="text" maxlength="100"/>	
			</td>
		</tr>
		<tr>
			<th>
			...
			<td>
				<span class="fieldSet">
					<input type="text" name="photo" id="photo" class="text" maxlength="200"/>
		...
		<tr>
			...
			<td>
			    <input type="text" name="identity" class="text" maxlength="100"/>
			</td>
		</tr>
		<tr>
			<th>
			...
			<td>
				<input type="text" name="education" class="text" maxlength="100"/>
			</td>
		</tr>
		<tr>
			<th>
			...
			<td>
				<input type="text" name="phone" class="text" maxlength="100"/>
			</td>
		</tr>								
		<tr>
			<th>
			...
			<td>
			<input type="text" name="water_rate" class="text" maxlength="100"/>
			</td>
		</tr>
		<tr>
			<th>
			...
			<td>
			<input type="text" name="power_rate" class="text" maxlength="100"/>
			</td>
		</tr>
			<th>
				煤费(单位：元):
			...
			<td>
			<input type="text" name="gas_rate" class="text" maxlength="100"/>
			</td>
		<tr>
			<th>
				其他维护费(单位：元):
			...
			<td>
			<input type="text" name="other_rate" class="text" maxlength="100"/>
			</td>
		</tr>	
		<tr>
			<th>
			...
			<td>
			<input type="text" name="total_rate" class="text" maxlength="100"/>
			</td>
		</tr>
		<tr>
			<th>
			...
			<td>
			<input type="text" name="authenticating_state" class="text" maxlength="100" title="认证状态" />
			</td>
		</tr>		
	</table>
	<table class="input">
