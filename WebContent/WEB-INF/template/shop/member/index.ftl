					...
					<div>
						<ul>
							...
							<li>
								...
								<img src="${base}/resources/shop/images/email1.jpg" width="30" high="30" alt="邮箱认证" title="邮箱认证"/>
								[#else]
								<img src="${base}/resources/shop/images/email0.jpg" width="30" high="30" alt="邮箱认证" title="邮箱认证" />
								[/#if]
								[#if member.activateEmail]
								<img src="${base}/resources/shop/images/mobile1.jpg" width="30" high="30" alt="手机认证" title="手机认证"/>
								[#else]
								<img src="${base}/resources/shop/images/mobile0.jpg" width="30" high="30" alt="手机认证" title="手机认证"/>
								[/#if]
								[#if member.activateEmail]
								<img src="${base}/resources/shop/images/realname1.jpg" width="30" high="30" alt="实名认证" title="实名认证"/>
								[#else]
								<img src="${base}/resources/shop/images/realname0.jpg" width="30" high="30" alt="实名认证" title="实名认证"/>
								[/#if]
							</li>
						</ul>
						<ul>
