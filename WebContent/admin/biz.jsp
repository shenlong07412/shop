...
<shiro:authenticated>
<%
response.sendRedirect(base + "/biz/common/main.jhtml");
%>
</shiro:authenticated>
<%
}
...
<script type="text/javascript">
	$().ready( function() {
		...
		$captchaImage.click( function() {
			$captchaImage.attr("src", "<%=base%>/biz/common/captcha.jhtml?captchaId=<%=captchaId%>&timestamp=" + (new Date()).valueOf());
		});
...
<body>
	<%if (applicationContext != null) {%>
		<div class="login">
			<form id="loginForm" action="biz.jsp" method="post">
				...
				<table>
					<tr>
						<td width="190" rowspan="2" align="center" valign="bottom">
							<img src="<%=base%>/resources/admin/images/biz_login_logo.gif" alt="SHOP++" />
						</td>
						<th>
					...
					<tr>
						...
						<td>
							...
							<label><a href="/admin/admin.jsp">平台版</a><lable>
						</td>
					</tr>
				</table>
				<div class="powered">COPYRIGHT © 2005-2013 XMSOFT.CN ALL RIGHTS RESERVED.</div>
			</form>
		</div>
	<%} else {%>
		<fieldset>
