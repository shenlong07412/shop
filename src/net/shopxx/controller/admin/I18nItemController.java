 ...
 * @version 3.0
 *//*
@Controller("adminI18nItemController")
@RequestMapping("/admin/i18nItem")
public class I18nItemController extends BaseController {
	...
	*//**
	 * 检查国际化项目是否存在
	 *//*
	@RequestMapping(value = "/check_i18nItem", method = RequestMethod.GET)
	public @ResponseBody
	boolean checkI18nItem(String localCode) {
		if (StringUtils.isEmpty(localCode)) {
			return false;
		}
		if (i18nItemService.localCodeExists(localCode)) {
			return false;
		} else {
			return true;
		}
