...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.plugin.qqOAuth.setting")}
	</div>
	<form id="inputForm" action="update.jhtml" method="post">
		<table class="input">
			<tr>
				<th>
					<span class="requiredField">*</span>${message("OAuthQQPlugin.OAuthName")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("OAuthQQPlugin.AppID")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("OAuthQQPlugin.AppKey")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("OAuthQQPlugin.RedirectUri")}:
				</th>
				<td>
			...
			<tr>
				<th>
					${message("OAuthQQPlugin.description")}:
				</th>
				<td>
			...
			<tr>
				<th>
					${message("OAuthQQPlugin.isEnabled")}:
				</th>
				<td>
					<label>
