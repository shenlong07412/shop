 ...
 * @author czllfy
 */
@Controller("oAuthSinaAdminController")
@RequestMapping("/admin/oauth_plugin/sina_oauth")
public class OAuthSinaController extends BaseController {

    @Resource(name = "oAuthSinaPlugin")
    private OAuthSinaPlugin     authPlugin;
    ...
    public String setting(ModelMap model) {
        ...
        return "/net/shopxx/plugin/oauth/sina_oauth_setting";
    }
