 ...
 */
package net.shopxx.shiro.filter;
 ...
 * @version 3.0
 */
public class BizAuthenticationFilter extends FormAuthenticationFilter {
    ...
    protected org.apache.shiro.authc.AuthenticationToken createToken(ServletRequest servletRequest,
        ...
        return new BizAuthenticationToken(username, password, captchaId, captcha, rememberMe, host);
    }
